...
class TestCase(unittest.TestCase):
    ...
    def test_009(self):
        ...
        assert self.RESULTADO == "Password must be between 4 and 20 characters!", "El resultado es diferente al esperado"
